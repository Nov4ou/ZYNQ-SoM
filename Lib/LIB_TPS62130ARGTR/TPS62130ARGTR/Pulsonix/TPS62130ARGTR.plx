...
//746696/1018887/2.50/17/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TPS62130ARGTR" (originalName "TPS62130ARGTR")
	...
	(compDef "TPS62130ARGTR" (originalName "TPS62130ARGTR") (compHeader (numPins 17) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "FSW") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "DEF") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "12" (pinName "PVIN_2") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "11" (pinName "PVIN_1") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "10" (pinName "AVIN") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "SS/TR") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "15" (pinName "PGND_1") (partNum 1) (symPinNum 15) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "14" (pinName "VOS") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "13" (pinName "EN") (partNum 1) (symPinNum 17) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS62130ARGTR"))
		...
		(attr "Manufacturer_Part_Number" "TPS62130ARGTR")
		(attr "Mouser Part Number" "595-TPS62130ARGTR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS62130ARGTR?qs=iIeLWXrA%252B1VxURRIvONmVg%3D%3D")
		(attr "Arrow Part Number" "TPS62130ARGTR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tps62130argtr/texas-instruments?utm_currency=USD&region=nac")
		(attr "Description" "3-V to 17-V, 3-A step-down converter with DCS-control in 3x3 QFN package")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tps62130a")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "TPS62130ARGTR.stp")
